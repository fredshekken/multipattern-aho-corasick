...
if __name__ == "__main__":
    # In a real database, "account" is a common keyword
    patterns = ["account", "password", "update"]
    scanner = AhoCorasickDFA(patterns)
    
    # CASE: A perfectly safe, normal message
    safe_text = "Hi ma, i-update ko lang po yung account settings ng Netflix natin."
    
    print("--- SOP 2 PROOF ---")
    scanner.search(safe_text)